...
\begin{figure}[!h]
\includegraphics[width=\linewidth]{bmc_template/figures/coverage_16s.png}
\caption{Trait annotation coverage across different body sites for the HMP 16S rRNA metabarcoding data. Panel \textbf{(A)} illustrates the proportion of present taxa per sample annotated to at least one trait. Panel \textbf{(B)} }
\label{fig:1}
\end{figure}
