...
\begin{flushleft}
{\Large
\textbf\newline{Evaluating trait-based sets for taxonomic enrichment analysis applied to human microbiome data sets}
}
\newline
% authors go here:
\\
...
The definition of each trait category is identical to Madin et al. \cite{madin2020synthesis} and can be found in the online-only table 2. 
